...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ProblemDetail handleException(IOException ex) {
    ...
    @ExceptionHandler(SensorMonitoringClientBadGetwayException.class)
    public ProblemDetail handleSensorMonitoringClientBadGetwayException(SensorMonitoringClientBadGetwayException ex) {
